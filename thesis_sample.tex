...
Standing Waves\\
\url{http://230nsc1.phy-astr.gsu.edu/hbase/Waves/standw.html}.\\
Retrieved 15 December 2020.

\bibitem{noiselevel}
Noise Level Chart: Decibel Levels of Common Sounds With Examples\\
\url{https://boomspeaker.com/noise-level-chart-db-level-chart/}.\\
Retrieved 15 December 2020.

\bibitem{cellotone}
Cello Tone Analysis\\
\url{https://vobarian.com/celloanly/index.html}.\\
Retrieved 15 December 2020.
...
\url{https://www.youtube.com/watch?v=ZAgiC0vtc8M&ab_channel=DanHosken}.\\
Retrieved 15 December 2020.

\bibitem{adsrenvinfo}
ADSR Envelopes: How to Build The Perfect Sound [Infographic]\\
\url{https://blog.landr.com/adsr-envelopes-infographic/}.\\
Retrieved 15 December 2020.

\bibitem{planetoftunes}
Planet of Tunes - Synthesis types\\
\url{http://www.planetoftunes.com/synthesis/synthesis-types.htm}.\\
Retrieved 15 December 2020.

\bibitem{stm32f4}
STM32F4-Discovery MIDI input and basic synthesis\\
\url{https://minddumpdotnet.wordpress.com/2013/05/23/stm32f4-discovery-midi-input-and-basic-synthesis/}.\\
Retrieved 15 December 2020.

\bibitem{linearfilter}
Linear filter\\
\url{https://en.wikipedia.org/wiki/Linear_filter}.\\
Retrieved 15 December 2020.

\bibitem{basicspassivercfilters}
What Is a Low Pass Filter? A Tutorial on the Basics of Passive RC Filters\\
\url{https://www.allaboutcircuits.com/technical-articles/low-pass-filter-tutorial-basics-passive-RC-filter/}.\\
Retrieved 15 December 2020.
