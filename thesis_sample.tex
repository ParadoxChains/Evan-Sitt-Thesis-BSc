...
\includegraphics[width=1.0]{OverallScreenshot.needed}
\chapter{Background}
...
\includegraphics[width=1.0]{ExtraOptions01.needed}
\includegraphics[width=1.0]{ExtraOptions02.needed}
...
\includegraphics[width=1.0]{MainOscScreenshot.needed}
...
\includegraphics[width=1.0]{AddOscScreenshot.needed}
...
\includegraphics[width=1.0]{SubOscScreenshot.needed}
...
\includegraphics[width=1.0]{LFOScreenshot.needed}
\subsection{Filter}
...
\includegraphics[width=1.0]{FilterScreenshot.needed}
\subsection{Envelope}
...
\includegraphics[width=1.0]{EnvelopeScreenshot.needed}
\subsection{Main}
...
\includegraphics[width=1.0]{MainControlScreenshot.needed}
